    ...
    <details className="mt-3">
      ...
      <form action={updateTeacherRoles} className="mt-3 space-y-2 rounded-lg bg-[#f7fafc] p-3">
        ...
        <select name="role" defaultValue={primaryRole} className="w-full rounded border border-[#c8d7e3] bg-white px-2 py-1.5 text-xs">
          ...
          <option value="GURU_TPA">Guru TPA</option>
          <option value="GURU_TAHFIDZH">Guru TAHFIDZH</option>
        ...
        <label className="flex items-center gap-2 text-xs text-slate-600"><input type="checkbox" name="role_guru_tpa" defaultChecked={additionalRoles.includes("GURU_TPA")} /> Guru TPA</label>
        <label className="flex items-center gap-2 text-xs text-slate-600"><input type="checkbox" name="role_guru_tahfizh" defaultChecked={additionalRoles.includes("GURU_TAHFIDZH")} /> Guru TAHFIDZH</label>
