    ...
    <main className="min-h-screen bg-[#f7fafc] px-5 py-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 xl:grid-cols-[360px_1fr]">
          <section className="h-fit rounded-xl border border-[#d8e3ec] bg-white p-5 shadow-sm"><h2 className="font-bold text-[#112b45]">Tambah santri</h2><p className="mt-1 text-xs text-slate-500">Cukup isi nama lengkap. Kode publik dibuat otomatis.</p><form action={createStudent} className="mt-5 space-y-4"><label className="block text-sm font-semibold text-[#112b45]">Nama lengkap *<input name="full_name" required className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal" /></label><label className="block text-sm font-semibold text-[#112b45]">Nama panggilan<input name="nickname" className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal" /></label><label className="block text-sm font-semibold text-[#112b45]">Jenis kelamin<select name="gender" defaultValue="" className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal"><option value="">Belum diisi</option><option value="L">Laki-laki</option><option value="P">Perempuan</option></select></label><label className="block text-sm font-semibold text-[#112b45]">Nama wali<input name="guardian_name" className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal" /></label><label className="block text-sm font-semibold text-[#112b45]">Nomor wali<input name="guardian_phone" className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal" /></label><label className="block text-sm font-semibold text-[#112b45]">Program<select name="program_id" className="mt-1.5 w-full rounded-lg border border-[#c8d7e3] px-3 py-2 text-sm font-normal"><option value="">Belum ditentukan</option>{programs?.map((program) => <option key={program.id} value={program.id}>{program.name}</option>)}</select></label><button className="w-full rounded-lg bg-[#e52335] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#c91d2e]">Simpan santri</button></form></section>
