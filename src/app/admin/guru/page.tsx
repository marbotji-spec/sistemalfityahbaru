  ...
  return (
    <main className="min-h-screen bg-[#f7fafc] px-5 py-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#147fbd]">Administrasi</p>
          <h1 className="mt-2 text-3xl font-bold text-[#112b45]">Data guru</h1>
          <p className="mt-2 text-slate-500">Nama wajib diisi. Email dan password diperlukan hanya agar guru dapat login.</p>
        </div>
        ...
        <div className="grid gap-8 xl:grid-cols-[360px_1fr]">
          <section className="h-fit rounded-xl border border-[#d8e3ec] bg-white p-5 shadow-sm">
            <h2 className="font-bold text-[#112b45]">Tambah akun guru</h2>
